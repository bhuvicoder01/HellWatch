...
const { listVideos, getThumbnail, getVideoById, streamVideo, deleteVideo, updateVideo, addQuality, transcodeVideo, checkTranscodingStatus, updateVideoMetadata, trackView } = require("../controllers/videoController");
...
// GET /videos/transcode/:jobId -> check transcoding job status
router.get("/transcode/:jobId", checkTranscodingStatus);
